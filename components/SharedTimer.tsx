...
export default function SharedTimer({ roomId }: SharedTimerProps) {
    ...
    return (
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-4 flex flex-col items-center shadow-sm transition-colors">
            ...
            <div className={`text-4xl font-mono font-bold mb-4 ${isActive ? 'text-gray-900 dark:text-white' : 'text-gray-400 dark:text-gray-500'}`}>
                {formatTime(seconds)}
            </div>
            ...
            <div className="flex gap-2 w-full">
                <button
                    ...
                    className={`flex-1 py-2 rounded-lg flex items-center justify-center transition-colors text-white ${isActive ? 'bg-yellow-600 hover:bg-yellow-500' : 'bg-blue-600 hover:bg-blue-500'}`}
                >
            ...
            <button onClick={switchMode} className="mt-2 text-xs text-gray-500 hover:text-gray-800 dark:hover:text-gray-300 underline">
