...
export default function Navbar({ onMenuClick }: NavbarProps) {
    ...
    return (
        <nav className="flex items-center justify-between border-b border-gray-800 bg-gray-900 px-4 md:px-6 py-4">
            <div className="flex items-center gap-4">
                <button
                    onClick={onMenuClick}
                    className="md:hidden p-2 -ml-2 text-gray-400 hover:text-white hover:bg-gray-800 rounded-md"
                >
