        ...
        <div className="rounded-xl border border-gray-800 bg-gray-900/50 p-6 backdrop-blur-sm">
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="text-lg font-bold text-white">Focus Streak</h3>
                        <p className="text-xs text-orange-400 font-medium">12 Day Streak! 🔥</p>
                    </div>
                </div>
                <div className="text-right">
                    <p className="text-2xl font-bold text-white">42.5h</p>
                    <p className="text-xs text-gray-500">Focus this month</p>
                </div>
            </div>
                ...
                <div className="grid grid-cols-7 gap-2">
                    {MOCKED_DAYS.map((day, idx) => (
                        <div key={idx} className="flex flex-col items-center gap-1">
                            <div
                                className={`h-8 w-full rounded-md transition-all hover:ring-2 hover:ring-indigo-400 hover:ring-offset-1 hover:ring-offset-gray-900 ${INTENSITY_COLORS[day.level as keyof typeof INTENSITY_COLORS]}`}
            ...
            <div className="flex items-center justify-between mt-4 py-3 border-t border-gray-800">
                ...
                <div className="text-xs text-gray-400">
                    Best Focus: <span className="text-white font-medium">8 PM - 11 PM</span>
                </div>
            </div>
        </div>
    );
